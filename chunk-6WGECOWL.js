import {e as l} from "./chunk-JOVT4LBN.js";
var f, x = l( () => {
    "use strict";
    f = typeof globalThis == "object" && "crypto"in globalThis ? globalThis.crypto : void 0
}
);
function m(t) {
...
var A, M, w, H, c, g, S = l( () => {
    ...
    M = A ? t => t : B,
    w = typeof Uint8Array.from([]).toHex == "function" && typeof Uint8Array.fromHex == "function",
    H = Array.from({
        length: 256
...
var a, h, P, Q, Y, Z, $, tt, et, nt, rt, ot, ct, ft, ut, st, pt, at, O = l( () => {
    "use strict";
    a = BigInt(4294967295),
    h = BigInt(32);
    P = (t, e, n) => t >>> n,
    ...
    pt = (t, e, n, r, o) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0) + (o >>> 0),
    at = (t, e, n, r, o, i) => e + n + r + o + i + (t / 2 ** 32 | 0) | 0
}
);
export {J as a, P as b, Q as c, Y as d, Z as e, $ as f, tt as g, et as h, nt as i, rt as j, ot as k, it as l, ct as m, ft as n, ut as o, st as p, pt as q, at as r, O as s, m as t, d as u, p as v, V as w, j as x, N as y, D as z, F as A, R as B, C, M as D, W as E, X as F, U as G, E as H, v as I, g as J, K, q as L, S as M};
