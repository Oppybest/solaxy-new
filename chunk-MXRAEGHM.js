import {a as In, b as qr} from "./chunk-YTUIZ7QE.js";
import {a as Mn, b as vt} from "./chunk-TLA6RWUK.js";
import {a as b, b as A, d as H, l as T} from "./chunk-JOVT4LBN.js";
var Tn = "0.1.1";
function En() {
    return Tn
}
...
;
function Bn(e, t) {
    return t?.(e) ? e : e && typeof e == "object" && "cause"in e && e.cause ? Bn(e.cause, t) : t ? null : e
}
function zn(e, t={}) {
...
var Cn = "0x82ad56cb";
var On = ""
  , Fn = "";
var It = "2.31.3";
var Mt = {
...
var u = class e extends Error {
    constructor(t, n={}) {
        let r = n.cause instanceof e ? n.cause.details : n.cause?.message ? n.cause.message : n.details
          , o = n.cause instanceof e && n.cause.docsPath || n.docsPath
          , s = Mt.getDocsUrl?.(A(b({}, n), {
            docsPath: o
        }))
          , i = [t || "An error occurred.", "", ...n.metaMessages ? [...n.metaMessages, ""] : [], ...s ? [`Docs: ${s}`] : [], ...r ? [`Details: ${r}`] : [], ...Mt.version ? [`Version: ${Mt.version}`] : []].join(`
`);
        super(i, n.cause ? {
            cause: n.cause
        } : void 0),
...
;
function Un(e, t) {
    return t?.(e) ? e : e && typeof e == "object" && "cause"in e && e.cause !== void 0 ? Un(e.cause, t) : t ? null : e
}
...
function P(e, {includeName: t=!1}={}) {
    if (e.type !== "function" && e.type !== "event" && e.type !== "error")
        throw new De(e.type);
    return `${e.name}(${ke(e.inputs, {
        includeName: t
    })})`
}
function ke(e, {includeName: t=!1}={}) {
    return e ? e.map(n => Kr(n, {
        includeName: t
    })).join(t ? ", " : ",") : ""
}
function Kr(e, {includeName: t}) {
    return e.type.startsWith("tuple") ? `(${ke(e.components, {
        includeName: t
...
function qn(e, t={}) {
    return typeof e == "number" || typeof e == "bigint" ? y(e, t) : typeof e == "string" ? zt(e, t) : typeof e == "boolean" ? Bt(e, t) : z(e, t)
}
function Bt(e, t={}) {
    let n = `0x${Number(e)}`;
...
var ro = new TextEncoder;
function et(e, t={}) {
    return typeof e == "number" || typeof e == "bigint" ? so(e, t) : typeof e == "boolean" ? oo(e, t) : B(e) ? ue(e, t) : jt(e, t)
}
function oo(e, t={}) {
...
function w(e, t) {
    ...
    if (St.has(r))
        return St.get(r);
    let o = ao.test(e) ? e.toLowerCase() === e ? !0 : n ? je(e) === e : !0 : !1;
    return St.set(r, o),
    o
}
var Rt = new ce(8192);
...
function Zn(e, {recursiveReadLimit: t=8192}={}) {
    let n = Object.create(uo);
    return n.bytes = e,
...
function L(e) {
    return typeof e[0] == "string" ? Q(e) : co(e)
}
function co(e) {
    let t = 0;
    for (let o of e)
...
var Ui = /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/
...
function fo(e) {
    ...
    return {
        dynamic: !1,
        encoded: k(e.toLowerCase())
    }
}
function mo(e, {length: t, param: n}) {
    let r = t === null;
    if (!Array.isArray(e))
        throw new ie(e);
    if (!r && e.length !== t)
    ...
    return {
        dynamic: !1,
        encoded: L(s.map( ({encoded: i}) => i))
    }
}
function lo(e, {param: t}) {
...
function bo(e, {signed: t, size: n=256}) {
    if (typeof n == "number") {
...
function xo(e, {param: t}) {
    ...
    return {
        dynamic: n,
        encoded: n ? Ot(r) : L(r.map( ({encoded: o}) => o))
    }
}
function st(e) {
    let t = e.match(/^(.*)\[(\d+)?\]$/);
...
function go(e) {
    ...
    return [je(z(Tt(t, -20))), 32]
}
function wo(e, t, {length: n, staticPosition: r}) {
    if (!n) {
        let i = O(e.readBytes(Ft))
          , a = r + i
          , c = a + nr;
        e.setPosition(a);
        let p = O(e.readBytes(nr))
          , f = Re(t)
          , d = 0
          , l = [];
        for (let m = 0; m < p; ++m) {
...
function vo(e) {
    return [Qn(e.readBytes(32), {
        size: 32
    }), 32]
}
function $o(e, t, {staticPosition: n}) {
    let[r,o] = t.type.split("bytes");
    if (!o) {
        let i = O(e.readBytes(32));
        e.setPosition(n + i);
    ...
    return [z(e.readBytes(Number.parseInt(o), 32)), 32]
}
function Ao(e, t) {
...
function Po(e, t, {staticPosition: n}) {
...
function it(e) {
    ...
    if (r === "0x")
        throw new re;
    let s = [...t || [], He, Dn].find(i => i.type === "error" && r === C(P(i)));
    if (!s)
        throw new oe(r,{
...
var U = (e, t, n) => JSON.stringify(e, (r, o) => {
    let s = typeof o == "bigint" ? o.toString() : o;
    return typeof t == "function" ? t(r, s) : s
}
, n);
function Ut({abiItem: e, args: t, includeFunctionName: n=!0, includeName: r=!1}) {
    if ("name"in e && "inputs"in e && e.inputs)
        return `${n ? e.name : ""}(${e.inputs.map( (o, s) => `${r && o.name ? `${o.name}: ` : ""}${typeof t[s] == "object" ? U(t[s]) : t[s]}`).join(", ")})`
}
var rr = nt;
function N(e) {
    let {abi: t, args: n=[], name: r} = e
      ...
      , s = t.filter(a => o ? a.type === "function" ? C(a) === r : a.type === "event" ? rr(a) === r : !1 : "name"in a && a.name === r);
    if (s.length === 0)
        return;
    if (s.length === 1)
        return s[0];
...
function Nt(e, t) {
    ...
    case "string":
        return n === "string";
    default:
        return r === "tuple" && "components"in t ? Object.values(t.components).every( (o, s) => Nt(Object.values(e)[s], o)) : /^u?int(8|16|24|32|40|48|56|64|72|80|88|96|104|112|120|128|136|144|152|160|168|176|184|192|200|208|216|224|232|240|248|256)?$/.test(r) ? n === "number" || n === "bigint" : /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/.test(r) ? n === "string" || e instanceof Uint8Array : /[a-z]+[1-9]{0,3}(\[[0-9]{0,}\])+$/.test(r) ? Array.isArray(e) && e.every(o => Nt(o, A(b({}, t), {
...
function or(e, t, n) {
    for (let r in e) {
        ...
        if (o.type === "tuple" && s.type === "tuple" && "components"in o && "components"in s)
            return or(o.components, s.components, n[r]);
        let i = [o.type, s.type];
...
var cr = class extends u {
    constructor({transaction: t}) {
        super("Cannot infer a transaction type from provided transaction.", {
            metaMessages: ["Provided Transaction:", "{", Ce(t), "}", "", "To infer the type, either provide:", "- a `type` to the Transaction, or", "- an EIP-1559 Transaction with `maxFeePerGas`, or", "- an EIP-2930 Transaction with `gasPrice` & `accessList`, or", "- an EIP-4844 Transaction with `blobs`, `blobVersionedHashes`, `sidecars`, or", "- an EIP-7702 Transaction with `authorizationList`, or", "- a Legacy Transaction with `gasPrice`"],
...
var pr = class extends u {
    constructor(t, {account: n, docsPath: r, chain: o, data: s, gas: i, gasPrice: a, maxFeePerGas: c, maxPriorityFeePerGas: p, nonce: f, to: d, value: l}) {
        let m = Ce({
            chain: o && `${o?.name} (id: ${o?.id})`,
            from: n?.address,
            to: d,
            value: typeof l < "u" && `${ut(l)} ${o?.nativeCurrency?.symbol || "ETH"}`,
            data: s,
            gas: i,
...
var ft = class extends u {
    constructor(t, {account: n, docsPath: r, chain: o, data: s, gas: i, gasPrice: a, maxFeePerGas: c, maxPriorityFeePerGas: p, nonce: f, to: d, value: l, stateOverride: m}) {
        let h = n ? ne(n) : void 0
          , g = Ce({
            from: h?.address,
            to: d,
    ...
    constructor({abi: t, data: n, functionName: r, message: o}) {
        ...
        if (n && n !== "0x")
            try {
                ...
                let {abiItem: f, errorName: d, args: l} = i;
                if (d === "Error")
                    c = l[0];
                else if (d === "Panic") {
                    let[m] = l;
                    ...
                    a = [m ? `Error: ${m}` : "", h && h !== "()" ? `       ${[...Array(d?.length ?? 0).keys()].map( () => " ").join("")}${h}` : ""]
                }
            } catch (f) {
                s = f
            }
...
;
var Ht = "/docs/contract/decodeFunctionResult";
function xr(e) {
...
var kt = "/docs/contract/encodeDeployData";
function Dt(e) {
...
var gr = "/docs/contract/encodeFunctionData";
function wr(e) {
...
function vr(e) {
    let {args: t} = e
      ...
      , o = n[0]
      , s = r
      , i = "inputs"in o && o.inputs ? F(o.inputs, t ?? []) : void 0;
    return Q([s, i ?? "0x"])
}
...
var Oe = class extends u {
    constructor({body: t, cause: n, details: r, headers: o, status: s, url: i}) {
        super("HTTP request failed.", {
            cause: n,
            details: r,
            metaMessages: [s && `Status: ${s}`, `URL: ${ee(i)}`, t && `Request body: ${U(t)}`].filter(Boolean),
...
var yt = class extends u {
    constructor({body: t, error: n, url: r}) {
        super("RPC Request failed.", {
            cause: n,
            details: n.message,
            metaMessages: [`URL: ${ee(r)}`, `Request body: ${U(t)}`],
...
var Ar = class extends u {
    constructor({body: t, url: n}) {
        super("The request took too long to respond.", {
            ...
            metaMessages: [`URL: ${ee(n)}`, `Request body: ${U(t)}`],
            name: "TimeoutError"
        })
    }
}
...
var Mo = -1
  , v = class extends u {
    constructor(t, {code: n, docsPath: r, metaMessages: o, name: s, shortMessage: i}) {
        ...
        this.name = s || t.name,
        this.code = t instanceof yt ? t.code : n ?? Mo
    }
}
  , $ = class extends v {
    constructor(t, n) {
...
function Er(e) {
    let t = {};
    return typeof e.authorizationList < "u" && (t.authorizationList = Eo(e.authorizationList)),
    ...
    typeof e.blobs < "u" && (typeof e.blobs[0] != "string" ? t.blobs = e.blobs.map(n => z(n)) : t.blobs = e.blobs),
    ...
    typeof e.type < "u" && (t.type = To[e.type]),
...
var ln = new Map;
function zr({fn: e, id: t, shouldSplitBatch: n, wait: r=0, sort: o}) {
    let s = () => T(this, null, function*() {
        let d = c();
        i();
        let l = d.map( ({args: m}) => m);
        l.length !== 0 && e(l).then(m => {
    ...
    return {
        ...
        schedule(d) {
            return T(this, null, function*() {
                let {promise: l, resolve: m, reject: h} = Br();
                return n?.([...a(), d]) && s(),
                c().length > 0 ? (p({
                    args: d,
                    resolve: m,
...
function Or(e, t) {
    return T(this, null, function*() {
        let $n = t
          , {account: n=e.account, authorizationList: r, batch: o=!!e.batch?.multicall, blockNumber: s, blockTag: i="latest", accessList: a, blobs: c, blockOverrides: p, code: f, data: d, factory: l, factoryData: m, gas: h, gasPrice: g, maxFeePerBlobGas: V, maxFeePerGas: ve, maxPriorityFeePerGas: $e, nonce: Fe, to: te, value: Dr, stateOverride: Lr} = $n
          , Gr = H($n, ["account", "authorizationList", "batch", "blockNumber", "blockTag", "accessList", "blobs", "blockOverrides", "code", "data", "factory", "factoryData", "gas", "gasPrice", "maxFeePerBlobGas", "maxFeePerGas", "maxPriorityFeePerGas", "nonce", "to", "value", "stateOverride"])
          , xn = n ? ne(n) : void 0;
        if (f && (l || m))
        ...
        try {
            ...
            let Ae = (typeof s == "bigint" ? y(s) : void 0) || i
              , _ = p ? Sn(p) : void 0
              , X = Sr(Lr)
              , An = e.chain?.formatters?.transactionRequest?.format
              , wt = (An || Er)(A(b({}, Tr(Gr, {
                format: An
            })), {
                from: xn?.address,
            ...
            let Wr = ( () => {
                let W = [wt, Ae];
                return X && _ ? [...W, X, _] : X ? [...W, X] : _ ? [...W, {}, _] : W
            }
            )()
              , Pn = yield e.request({
                method: "eth_call",
            ...
            let Ae = Co(gt)
              , {offchainLookup: _, offchainLookupSignature: X} = yield import("./chunk-HBQ2DNXM.js");
            if (e.ccipRead !== !1 && Ae?.slice(0, 10) === X && te)
                return {
                    data: yield _(e, {
                        data: Ae,
                        to: te
            ...
            throw vn && Ae?.slice(0, 10) === "0x101bb98d" ? new mt({
                factory: l
            }) : Mr(gt, A(b({}, t), {
                account: xn,
                chain: e.chain
...
function zo({request: e}) {
    let o = e
      , {data: t, to: n} = o
      , r = H(o, ["data", "to"]);
    return !(!t || t.startsWith(Cn) || !n || Object.values(r).filter(s => typeof s < "u").length > 0)
}
function jo(e, t) {
    return T(this, null, function*() {
        let {batchSize: n=1024, wait: r=0} = typeof e.batch?.multicall == "object" ? e.batch.multicall : {}
          , {blockNumber: o, blockTag: s="latest", data: i, multicallAddress: a, to: c} = t
          , p = a;
        if (!p) {
            if (!e.chain)
                throw new Ie;
        ...
        let d = (typeof o == "bigint" ? y(o) : void 0) || s
          ...
          , [{returnData: m, success: h}] = yield l({
            data: i,
            to: c
        });
        if (!h)
...
function So(e) {
    let {code: t, data: n} = e;
    return Dt({
        abi: vt(["constructor(bytes, bytes)"]),
        bytecode: On,
        args: [t, n]
    })
}
function Ro(e) {
    ...
    return Dt({
        abi: vt(["constructor(address, bytes, address, bytes)"]),
        bytecode: Fn,
        args: [o, t, n, r]
    })
}
  ...
  , ht = class extends u {
    constructor({result: t, url: n}) {
        super("Offchain gateway response is malformed. Response data must be a hex value.", {
            metaMessages: [`Gateway URL: ${ee(n)}`, `Response: ${U(t)}`],
...
function Ur(e) {
    let {abi: t, data: n} = e
      , r = R(n, 0, 4)
      , o = t.find(s => s.type === "function" && r === C(P(s)));
    if (!o)
        throw new Ye(r,{
...
var yn = "/docs/contract/encodeErrorResult";
function bn(e) {
...
var hn = "/docs/contract/encodeFunctionResult";
function Nr(e) {
    ...
    return F(o.outputs, s)
}
var Hr = "x-batch-gateway:true";
function kr(e) {
    return T(this, null, function*() {
        let {data: t, ccipRequest: n} = e
          ...
          , o = []
          , s = [];
        return yield Promise.all(r.map( (i, a) => T(this, null, function*() {
            try {
                s[a] = yield n(i),
                o[a] = !1
            } catch (c) {
...
function Oo(e) {
    return e.name === "HttpRequestError" && e.status ? bn({
        abi: Ne,
        errorName: "HttpError",
...
function cf(s, i) {
    return T(this, arguments, function*(e, {blockNumber: t, blockTag: n, data: r, to: o}) {
        let {args: a} = it({
            data: r,
            abi: [Fo]
        })
          , [c,p,f,d,l] = a
          , {ccipRead: m} = e
          , h = m && typeof m?.request == "function" ? m.request : Uo;
        try {
            if (!Fr(o, c))
                throw new xt({
                    sender: c,
        ...
        for (let s = 0; s < n.length; s++) {
            ...
            try {
                ...
                !f.ok) {
                    o = new Oe({
                        body: c,
                        details: d?.error ? U(d.error) : f.statusText,
                        headers: f.headers,
                        status: f.status,
                        url: i
                    });
...
export {u as a, B as b, x as c, K as d, et as e, ue as f, Et as g, Wn as h, Us as i, qn as j, z as k, y as l, zt as m, re as n, Ln as o, L as p, Q as q, M as r, ce as s, tt as t, je as u, Ii as v, w, Ui as x, tr as y, F as z, ne as A, Zn as B, Nn as C, Hn as D, sr as E, Ba as F, at as G, E as H, G as I, we as J, ut as K, Ce as L, cr as M, pr as N, dr as O, fr as P, mr as Q, U as R, Oe as S, yt as T, Ar as U, Lt as V, Gt as W, Vt as X, Wt as Y, qt as Z, Jt as _, Yt as $, _t as aa, Xt as ba, Zt as ca, Kt as da, Qt as ea, en as fa, tn as ga, nn as ha, rn as ia, on as ja, sn as ka, an as la, un as ma, cn as na, pn as oa, dn as pa, fn as qa, mn as ra, Pr as sa, Ir as ta, Tr as ua, Er as va, Cr as wa, Sr as xa, Pt as ya, xr as za, vr as Aa, $r as Ba, yr as Ca, br as Da, hr as Ea, lt as Fa, Br as Ga, zr as Ha, uf as Ia, Fo as Ja, cf as Ka, Uo as La, Or as Ma};
